...
function getSystemPrompt() {
  ...
  const langMap = {
    hinglish: 'IMPORTANT: Always respond in Hinglish — natural mix of Hindi and English. Example: "Achha beta, yeh formula yaad karo! Simple trick: base × height / 2"',
    english:  'Always respond in clear, simple English only. No Hindi words.',
    hindi:    'हमेशा सरल हिंदी में जवाब दो। गणित के terms English में लिखना ठीक है।',
    marathi:  'कृपया नेहमी मराठीत उत्तर द्या. गणिताचे terms English मध्ये ठीक आहे.',
    bengali:  'সর্বদা বাংলায় উত্তর দিন। গণিতের terms English এ লেখা ঠিক আছে।',
    tamil:    'எப்போதும் தமிழில் பதில் கொடுங்கள். கணித terms English இல் சரி.',
    telugu:   'ఎల్లప్పుడూ తెలుగులో సమాధానం ఇవ్వండి. గణిత terms English లో సరే.',
    gujarati: 'હંમેશા ગુજરાતીમાં જવાબ આપો. ગણિતના terms English માં ઠીક છે.',
    kannada:  'ಯಾವಾಗಲೂ ಕನ್ನಡದಲ್ಲಿ ಉತ್ತರಿಸಿ. ಗಣಿತದ terms English ನಲ್ಲಿ ಸರಿ.',
    punjabi:  'ਹਮੇਸ਼ਾ ਪੰਜਾਬੀ ਵਿੱਚ ਜਵਾਬ ਦਿਓ। ਗਣਿਤ ਦੇ terms English ਵਿੱਚ ਠੀਕ ਹੈ।',
    odia:     'ସର୍ବଦା ଓଡ଼ିଆରେ ଉତ୍ତର ଦିଅ। ଗଣିତ terms English ରେ ଠିକ ଅଛି।',
  };
