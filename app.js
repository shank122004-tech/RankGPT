'use strict';
// ── SSC PrepAI app.js  v12 ──────────────────────────────────

// ===== CONFIGURATION =====

// ── API endpoints — always use direct Cloud Run URLs ─────────
// Site is on GitHub Pages which cannot handle /api/* rewrites.
...
SUBJECT COVERAGE: ${modeDesc}`;
  }

  // SSC Exam Mode
  return `You are PrepAI, an expert SSC exam coach focused on ${modeDesc}.
...
TOPICS: Quantitative Aptitude, English Language, General Reasoning, General Knowledge/Current Affairs.`;
}
